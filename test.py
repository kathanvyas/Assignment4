...
x_train = mat_to_array(filepath_data_1000,0,1000,'x1000')
x_test = mat_to_array(filepath_data_10k,0,10000,'x10k')
...
class SRelu:
    ...
    @staticmethod
    def prime(z):
        return SRelu.activation(z) * (1 - SRelu.activation(z))
class Sigmoid:
    @staticmethod
    def activation(z):
        return 1 / (1 + np.exp(-z))
...
if __name__ == "__main__":
    ...
    nn = Network((1, 1, 1), (SRelu, NoActivation))
